...
/**
 * Generated class for the UpdateDirrectTeamPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-update-dirrect-team',
  templateUrl: 'update-dirrect-team.html',
})
export class UpdateDirrectTeamPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad UpdateDirrectTeamPage');
  }
